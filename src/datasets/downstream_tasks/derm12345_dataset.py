...
class Derm12345Dataset(GenericImageDataset):
    """DERM12345 dermatoscopic skin lesion dataset.

    12,345 dermatoscopic images from 1,627 patients (Turkish institutions,
    2008-2021), organised into 5 super / 15 main / 40 sub classes; released
    CC-BY and mirrored on the ISIC archive. Expects the ISIC-archive metadata
    export (same schema as MSKCC/HIBA) with images under
    ``<dataset_dir>/images``.
    """
    ...
    def __init__(
        ...
        derm12345_meta_name: Union[str, Path] = "derm12345.csv",
        transform=None,
        val_transform=None,
        ...
        **kwargs,
        ...
        """
        Initializes the DERM12345 dataset.

        Parameters
        ----------
        dataset_dir : str
            Directory with all the images.
        derm12345_meta_name : str
        ...
        self.meta_data = pd.read_csv(self.dataset_dir / derm12345_meta_name)
        ...
        self.meta_data["dataset_desc"] = "DERM12345"
